\chapter{Le m\'etier d'enseignant-chercheur}
...
{\lien{www.enseignementsup-recherche.gouv.fr/cid22657/maitres-conferences.html}}
...
{\lien{www.enseignementsup-recherche.gouv.fr/cid22705/professeur-des-universites.html}}
...
\index{Enseignant$\cdot$e-chercheur$\cdot$se (EC)}
\index{Ma\^\i tre de conf\'erences (MCF)}
\index{Professeur$\cdot$e d'universit\'e (PR)}
...
%Fin 2013, il y avait 3204 enseignants-chercheurs dans les sections 25 et 26 du CNU (6,50\% des effectifs) et
%401 chercheurs CNRS rattach\'es \`a l'INSMI (3,58\% des effectifs).
%\`A Inria, sur les 609 chercheurs en poste, environ 15\% sont rattach\'es au secteur ``Math\'ematiques appliqu\'ees, calcul et simulation''.%
%\footnote{Il y a \'egalement des chercheurs en math\'ematiques dans les autres secteurs.}

La proportion de enseignantes-chercheuses en math\'ematiques \'etait, en 2015, de 20.9\,\%. %(156+33+383+92)/(857+530+1161+626) 
Le d\'es\'equilibre est encore plus important chez les PR (10,8\% de %(33+92)/(530+626)
femmes) que chez les MCF (26,7\%). %(156+383)/(857+1161)
...
Ces donn\'es ont \'et\'e compil\'ees \`a partir des \href{http://www.enseignementsup-recherche.gouv.fr/cid22708/bilans-statistiques.html}{%
...
\begin{center}
\begin{figure}[p]
\subfloat[\'Evolution du nombre d'enseignant$\cdot$es-chercheur$\cdot$ses des sections 25 et 26 du CNU]{\label{fig.demog.cnu}%
\includegraphics[width=8.5cm]{Images/demographie_cnu}
}
\hfill
\subfloat[\'Evolution du nombre de ma\^itres de conf\'erence et de professeurs -- le nombre total d'EC au MESRI se lit sur 
l'axe de droite]{\label{fig.demog.mcfpr}%
\includegraphics[width=8.5cm]{Images/demographie_statut}
}
...
\begin{figure}[p]
\subfloat[\'Evolution du nombre de qualifi\'e$\cdot$es]{\label{fig.qualif}%
...
\liens{www.galaxie.enseignementsup-recherche.gouv.fr/ensup/candidats.html}

ou sur le site de l'Op\'eration Postes \lien{postes.smai.emath.fr/}.
...
site \lien{www.legifrance.gouv.fr/}.
...
Le comit\'e doit comprendre autant de femmes que d’hommes, avec des dispositions transitoires pour les comités PR de certaines sections du CNU 
...
Le$\cdot$La pr\'esident$\cdot$e ou le$\cdot$la directeur$\cdot$trice de l'\'etablissement peut \'emettre un avis d\'efavorable motiv\'e sur le candidat retenu par
...
\href{https://www.galaxie.enseignementsup-recherche.gouv.fr/ensup/etab_FAQ_comites_selection.html}{Lien Galaxie : FAQ sur les comit\'es de s\'election.}
...
{\liens{www.galaxie.enseignementsup-recherche.gouv.fr/ensup/cand\_qualification.htm}}

Habituellement, les candidatures se d\'eclarent entre mi-septembre et mi-octobre, 
par inscription sur le site Antares de Galaxie : \liens{galaxie.enseignementsup-recherche.gouv.fr/antares/can/index.jsp}.
...
ou au site de l'Operation Postes : \lien{postes.smai.emath.fr/2015/CONCOURS/qualification/index.php}.
...
{\lien{www.enseignementsup-recherche.gouv.fr/cid22708/bilans-statistiques.html}}
...
Tout$\cdot$e enseignant$\cdot$e-chercheur$\cdot$se est rattach\'e$\cdot$e \`a une unit\'e de formation
...
recherche.
\index{Ecoles supérieures du professorat et de l'\'education (ESPE)}
...
fran\c caise. \lien{annuaire.emath.fr}
...
Les EC sont \'evalu\'e$\cdot$es lors de quelques moments importants de leurs carri\`eres.
...
\lien{www.sauvonsluniversite.com/spip.php?article3423}.
...
% 
% Point 1 : ``Lors de la session d'attribution des promotions, la section CNU 26 n'\'emettra pas d'avis sur les dossiers des coll\`egues non promus." - Adopt\'e \`a l'unanimit\'e
% 
% Point 2 : ``Les membres de la section 26 r\'eunis le 3 f\'evrier 2010 rappellent leur refus de si\'eger pour une \'eventuelle session d'\'evaluation quadriennale durant leur mandat." - Unanimit\'e moins une abstention.



\index{Evaluation ! \`a l'universit\'e}
\index{Publiants}
\index{Agence d'\'evaluation de la recherche et de l'enseignement sup\'erieur (AERES)}
...
\index{Professeur$\cdot$e d'universit\'e (PR)!seconde classe}
\index{Professeur$\cdot$e d'universit\'e (PR)!premi\`ere classe}
\index{Professeur$\cdot$e d'universit\'e (PR)!classe exceptionnelle}
...
\index{Professeur d'universit\'e (PR)!promotions}
...
par rapport au SMIC de plus de 30\,\% depuis 1990 (passage de 2,07 au 01/01/90 \`a 1,44 fois le SMIC au 01/01/15)\ldots
...
\lien{www.fonction-publique.gouv.fr/remunerations}.
...
% 
% \lien{www.dgdr.cnrs.fr/drh/carriere/cherch/pes.htm}.
...
\lien{www.galaxie.enseignementsup-recherche.gouv.fr/ensup/cand\_PEDR.htm}
...
les activit\'es  de recherche et d'enseignement sur les quatre derni\`eres ann\'ees. Ceci se fait en ligne, par une application du minist\`ere :
 ...
 \liens{galaxie.enseignementsup-recherche.gouv.fr/antares/ech/index.jsp}. 
...
%{\small \lien{www.dgdr.cnrs.fr/drh/carriere/cherch/documents/pes/2012/Decision\_INSMI.pdf}.}\\
...
\lien{smai.emath.fr/IMG/pdf\_Note\_PES2010.pdf}
...
\lien{www.sauvonsluniversite.com/spip.php?article3073}
...
\lien{smf4.emath.fr/Publications/Gazette/2010/126/smf\_gazette\_126\_97-99.pdf}
...
Enfin, la PEDR peut aussi \^etre convertie, pour tout ou partie, en d\'echarge de service d'enseignement, par d\'ecision du ou de la pr\'esident$\cdot$e ou du ou de la directeur$\cdot$trice de l'\'etablissement, selon des modalit\'es d\'efinies par le Conseil d'administration (CA).
...
Les enseignants-chercheurs et enseignantes-chercheuses peuvent \^etre d\'etach\'e$\cdot$es pour une
...
Elles et ils peuvent \'egalement \^etre mis \`a disposition des \'ecoles
...
Le dossier de mutation doit \^etre envoy\'e au directeur ou directrice de l'UFR de l'universit\'e correspondant \`a l'emploi demand\'e. Une copie du formulaire de demande de mutation et du CV doit \^etre envoy\'ee au minist\`ere.

%Il est \`a noter que, si l'on ne dispose pas de trois ans
...
\lien{postes.smai.emath.fr/apres/echanges/procedure.php}
...
\lien{postes.smai.emath.fr/apres/echanges/index.php}
...
\lien{www.dgdr.cnrs.fr/drh/emploi-nonperm/pratique-3-deleg.htm}
...
\liens{www.inria.fr/institut/recrutement-metiers/offres/accueil-en-delegation}
