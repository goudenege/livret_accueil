...
\emph{Pr\'esident$\cdot$e actuel$\cdot$le : \verifier{Olivier Goubet}} \hfill Site web : \lien{smai.emath.fr}, Facebook-Twitter : @smai-media
\smallskip
...
\emph{Pr\'esident$\cdot$e actuel$\cdot$le~: \verifier{Jean-Michel Marin}} \hfill Site web~: \lien{www.sfds.asso.fr/}
\smallskip
...
\emph{Pr\'esident$\cdot$e actuel$\cdot$le : \verifier{Fabien Durand}} \hfill Site web :  \lien{smf.emath.fr/}
\smallskip
