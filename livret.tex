...
\textbf{\Huge Livret d'accueil des math\'ematicien\mp nes}
...
\include{chap_01_MCF}
\include{chap_02_CR_CNRS}
\include{chap_03_CR_INRIA}
\include{chap_04_CR_INRAE}
...
\include{chap_07_ministere}
\include{chap_08_universite} 
\include{chap_09_CNRS}
\include{chap_10_INRIA}
\include{chap_11_INRAE}
\include{chap_12_HCERES}
\include{chap_13_CNU}
\include{chap_14_CoNRS}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Le financement de la recherche}

\include{chap_15_fin_sources}
\include{chap_15_fin_rec}
\include{chap_15_fin_non_rec_2019}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{La communaut\'e math\'ematique}

\include{chap_16_societes_savantes}
\include{chap_17_associations}
\include{chap_18_com}
\include{chap_19_listes_diffusion}
